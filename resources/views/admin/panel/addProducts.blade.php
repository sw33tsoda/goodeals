  ...
  <div class="row">
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <input type="text" class="form-control form-control-custom" id="exampleInputName1" placeholder="Name" name="name">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">Nhà sản xuất</label>
        <input type="text" class="form-control form-control-custom" id="exampleInputName1" placeholder="Developer" name="developer">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">Nhà phát hành</label>
        <input type="text" class="form-control form-control-custom" id="exampleInputName1" placeholder="Publisher" name="publisher">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control form-control-custom" id="exampleInputName1" placeholder="Price" name="price">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">Mô tả sản phẩm</label>
        <textarea type="text" class="form-control form-control-custom" id="exampleInputName1" placeholder="Description" name="desc"></textarea>
      </div>
    </div>
    <div class="col-lg-6">
      <div class="form-group">
        <label for="exampleInputPassword1">Ảnh đính kèm</label>
        <input type='file' class="form-control form-control-custom" id="imgInput" name="image" value="NULL" style="display: none;" accept=".jpg,.jpeg,.png"/>
