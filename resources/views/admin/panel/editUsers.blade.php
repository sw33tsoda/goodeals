...
@endif
<form method="POST" class="editUsers row" action="{{url('/admin/editUsers/post/')}}/{{$userInfo->id}}" enctype="multipart/form-data">
  {{ csrf_field() }}
...
<div class="col-lg-6">
  <div class="row">
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <input type="name" class="form-control form-control-custom" id="exampleInputName1" placeholder="Name" name="name" value="{{$userInfo->name}}">
      </div>
    </div>
    <div class="col-lg-6">
      <div class="form-group">
        <label for="exampleInputEmail1">Địa chỉ Email</label>
        <input type="email" class="form-control form-control-custom" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="email" value="{{$userInfo->email}}">
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-6">
      <div class="form-group">
        ...
        <input type="password" class="form-control form-control-custom" id="exampleInputPassword1" placeholder="Riêng tư" name="password">
      </div>
    </div>
    <div class="col-lg-6">
      <div class="form-group">
 ...
 <div class="col-lg-6" style="margin-bottom: 40px;">
  ...
  @if ($userInfo->avatar == "to_be_uploaded")
    <center><div id="preview_ghost" style="border-radius:10px;width:50%;height:50%;opacity: 0.3"><p style="line-height:100.938px;text-align: center;font-size: 25px; font-weight: bolder;">Chưa có ảnh</p></div></center>
  @else
...
<button type="submit" class="btn btn-primary-custom submit">Sửa</button>
